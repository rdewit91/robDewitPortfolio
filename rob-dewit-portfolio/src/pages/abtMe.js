  ...
  return (
    ...
    <div className={abtMeStyles.abtBox} >
      ...
      <div className={abtMeStyles.abtCont}>
        <Image src={vet} height="400" width="400"/>
      ...
      <br></br>
      <div className={abtMeStyles.abtCont}>
        <Image src={grad} height="400" width="400"/>
        <div className={abtMeStyles.abtRightText} >
          <p className={abtMeStyles.abtText} >In addition to my technical skills, I hold a Bachelor's degree from the State University of New York at Brockport with a dual major in Criminal Justice and Sociology. </p>
        </div>
      </div>
      <br></br>
      <div className={abtMeStyles.abtCont} >
