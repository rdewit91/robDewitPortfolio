  ...
  return (
    ...
    <div className={abtMeStyles.abtBox} >
      ...
      <div className={abtMeStyles.abtCont}>
        <Image src={vet} alt="vetImg" height="400" width="400"/>
      ...
      <br></br>
      <div className={abtMeStyles.abtCont}>
        <Image src={grad} alt="gradImg" height="400" width="400"/>
        <div className={abtMeStyles.abtRightText} >
      ...
      <div className={abtMeStyles.abtCont} >
        ...
        <Image src={learn} alt="lrnImg" height="300" width="600"/>
      </div>
      <br></br>
      <div className={abtMeStyles.abtCont} >
        <Image src={bjjKbx} alt="bjjKbxImg" height="300" width="600"/>
        <div className={abtMeStyles.abtRightText} >
